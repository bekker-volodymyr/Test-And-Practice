...
{
    [Test]
    public void with_90_armor_takes_10_percent_of_damage()
    {
        // ARRANGE
        ...
        // ACT
        float calculatedDamage = DamageCalculator.CalculateDamage(1000, character);

        // ASSERT
        Assert.AreEqual(100f, calculatedDamage);
    }
}
